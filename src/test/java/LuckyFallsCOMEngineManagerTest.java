...
public class LuckyFallsCOMEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(LuckyFallsCOMEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LuckyFallsIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LuckyFallsIW/InitOutcome.xml").getDocumentElement();
